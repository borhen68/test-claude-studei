...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section - Frametale Brand Colors */}
      <div className="bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-6">
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {/* Photo Book - Large Featured Card with Frametale Gradient */}
            <div 
              onClick={() => router.push('/upload')}
              className="bg-frametale-gradient rounded-3xl p-8 md:p-12 text-white cursor-pointer hover:scale-[1.02] transition-transform shadow-xl row-span-2 flex flex-col justify-between min-h-[500px]"
            >
              ...
              <div>
                ...
                <p className="text-xl text-white/90 mb-4">from $39</p>
                <div className="inline-flex items-center gap-2 bg-white text-[#0376AD] px-6 py-3 rounded-full font-semibold hover:bg-white/90 transition-colors">
                  Create Now
            ...
            <div className="grid grid-rows-2 gap-6">
              {/* Photo Calendar - Lighter Teal */}
              <div 
                onClick={() => router.push('/upload')}
                className="rounded-3xl p-8 text-white cursor-pointer hover:scale-[1.02] transition-transform shadow-xl flex flex-col justify-between min-h-[240px]"
                style={{ background: 'linear-gradient(135deg, #28BAAB 0%, #1FA89A 100%)' }}
              >
                ...
                <div>
                  ...
                  <p className="text-lg text-white/90 mb-3">from $29</p>
              ...
              {/* Greeting Cards - Deeper Blue */}
              <div 
                onClick={() => router.push('/upload')}
                className="rounded-3xl p-8 text-white cursor-pointer hover:scale-[1.02] transition-transform shadow-xl flex flex-col justify-between min-h-[240px]"
                style={{ background: 'linear-gradient(135deg, #0376AD 0%, #025987 100%)' }}
              >
                <div className="flex-1 flex items-center justify-center mb-4">
                  <div className="w-32 h-32 bg-white/10 rounded-xl backdrop-blur-sm flex items-center justify-center">
                    <span className="text-6xl">💌</span>
                ...
                <div>
                  ...
                  <p className="text-lg text-white/90 mb-3">from $19</p>
                  <div className="inline-flex items-center gap-2 text-sm font-semibold">
                    Create Now
                    <ArrowRight className="h-4 w-4" />
                  </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="text-center">
              <div className="aspect-[4/5] rounded-2xl mb-6 shadow-lg flex items-center justify-center"
                   style={{ background: 'linear-gradient(135deg, #28BAAB20 0%, #0376AD20 100%)' }}>
            ...
            <div className="text-center">
              <div className="aspect-[4/5] rounded-2xl mb-6 shadow-lg flex items-center justify-center"
                   style={{ background: 'linear-gradient(135deg, #28BAAB15 0%, #0376AD15 100%)' }}>
                <div className="text-8xl">📘</div>
              </div>
            ...
            <div className="text-center">
              <div className="aspect-[4/5] rounded-2xl mb-6 shadow-lg flex items-center justify-center"
                   style={{ background: 'linear-gradient(135deg, #28BAAB25 0%, #0376AD25 100%)' }}>
                <div className="text-8xl">📖</div>
              </div>
      ...
      {/* AI Features - Frametale Brand Colors */}
      <div className="py-20" style={{ background: 'linear-gradient(135deg, #28BAAB08 0%, #0376AD08 100%)' }}>
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <button
                onClick={() => router.push('/upload')}
                className="mt-10 px-10 py-5 bg-frametale-gradient text-white rounded-full font-bold text-lg hover:shadow-2xl hover:scale-105 transition-all inline-flex items-center gap-3"
              >
                Try It Free
            ...
            <div className="relative">
              <div className="aspect-square rounded-3xl shadow-2xl flex items-center justify-center"
                   style={{ background: 'linear-gradient(135deg, #28BAAB15 0%, #0376AD15 100%)' }}>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {featuredTestimonials.map((testimonial) => (
              <div key={testimonial.id} className="rounded-2xl p-8 shadow-md"
                   style={{ background: 'linear-gradient(135deg, #28BAAB10 0%, #0376AD10 100%)' }}>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-frametale-gradient" />
                  <div>
      ...
      {/* Final CTA - Frametale Brand Gradient */}
      <div className="bg-frametale-gradient py-24">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <button
            onClick={() => router.push('/upload')}
            className="px-12 py-6 bg-white text-[#0376AD] rounded-full font-bold text-xl hover:bg-white/90 transition-all transform hover:scale-105 shadow-2xl inline-flex items-center gap-3"
          >
            Start Creating Free
            <ArrowRight className="h-6 w-6" />
          </button>
          <p className="text-white/90 text-sm mt-6 flex items-center justify-center gap-6 flex-wrap">
